...
const MenuModal = ({
    ...
    const serverConnectionButtonClass = isServerConnected ? '' : 'button-disconnected'
    ...
    return (
        <ReactModal
            ...
            <div style={styles.buttonWrapper}>
                ...
                <button className={'button-banner ' + serverConnectionButtonClass} onClick={handleOnStop}>
