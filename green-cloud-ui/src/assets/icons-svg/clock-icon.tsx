 ...
 */
const ClockIcon = ({ size, color }: IconProps) => {
   ...
   return (
      ...
      >
         <g>
            <path
               {...{ fill }}
               d="M460.377,61.143c-9.835-5.704-22.4-2.329-28.104,7.545l-20.554,35.567l71.221,41.109l20.555-35.567
		c5.661-9.874,2.29-22.4-7.545-28.104L460.377,61.143z"
            />
            <path
               {...{ fill }}
               d="M149.189,61.143l-35.568,20.555c-9.835,5.704-13.206,18.226-7.549,28.104l20.554,35.568l71.222-41.109l-20.555-35.567
		C171.589,58.814,159.024,55.443,149.189,61.143z"
            />
            <path
               {...{ fill }}
               d="M306,92.56c13,0,25.699,1.272,38.25,3.065V62.357l26.297-0.201V19.125C370.547,8.554,361.993,0,351.422,0h-90.643
		c-10.571,0-19.125,8.554-19.125,19.125v43.031l26.096,0.201v33.268C280.301,93.832,293,92.56,306,92.56z"
            />
            <path
               {...{ fill }}
               d="M306,203.5c-88.295,0-159.875,71.575-159.875,159.875c0,88.3,71.575,159.875,159.875,159.875
		...
		C391.264,306.02,338.24,384.235,328.988,392.67z"
            ...
            <path
               {...{ fill }}
               d="M306,114.75c-137.312,0-248.625,111.312-248.625,248.625S168.688,612,306,612s248.625-111.312,248.625-248.625
