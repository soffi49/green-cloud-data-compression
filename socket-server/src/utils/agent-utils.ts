...
import { AGENTS_REPORTS_STATE, changeCloudNetworkCapacityEvent, addGreenSourcesToServer, addServersToCNA } from "../module"
...
const registerServer = (data) => {
    ...
    changeCloudNetworkCapacityEvent(data.cloudNetworkAgent, data.name, data.initialMaximumCapacity, true)
