...
public enum ExecutionJobStatusEnum {
	...
	public static final Set<ExecutionJobStatusEnum> ACCEPTED_JOB_STATUSES = EnumSet.of(ACCEPTED, IN_PROGRESS,
			...
			ON_HOLD_TRANSFER, ON_HOLD_TRANSFER_PLANNED, ON_HOLD_SOURCE_SHORTAGE_PLANNED, ON_HOLD_SOURCE_SHORTAGE);

	public static final Set<ExecutionJobStatusEnum> ACCEPTED_BY_SERVER_JOB_STATUSES =
	...
	public static final Set<ExecutionJobStatusEnum> JOB_ON_HOLD_STATUSES = EnumSet.of(ON_HOLD, ON_HOLD_TRANSFER,
			ON_HOLD_TRANSFER_PLANNED, ON_HOLD_SOURCE_SHORTAGE);
	...
	public static final Set<ExecutionJobStatusEnum> BACK_UP_POWER_STATUSES = EnumSet.of(
			IN_PROGRESS_BACKUP_ENERGY_PLANNED,
			IN_PROGRESS_BACKUP_ENERGY);
}
