package agents.cloudnetwork.behaviour.jobhandling.handler.logs;
...
public class JobHandlingHandlerLog {
	...
	public static final String JOB_DELAY_LOG = "[{}] There is no message regarding the job start. Sending request to the server";
