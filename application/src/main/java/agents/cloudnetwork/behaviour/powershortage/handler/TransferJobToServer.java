...
public class TransferJobToServer extends WakerBehaviour {
	 ...
	 */
	public static TransferJobToServer createFor(final CloudNetworkAgent cloudNetworkAgent,
		...
		return new TransferJobToServer(cloudNetworkAgent, Date.from(transferTime.toInstant()),
