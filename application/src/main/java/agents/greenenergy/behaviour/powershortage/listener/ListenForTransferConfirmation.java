...
/**
 * Behaviour is responsible for catching the information confirming that the job transfer was
 * successful
 */
public class ListenForTransferConfirmation extends CyclicBehaviour {
  ...
  private static final MessageTemplate messageTemplate =
      MessageTemplate.and(
          MatchPerformative(INFORM), MatchProtocol(POWER_SHORTAGE_SOURCE_TRANSFER_PROTOCOL));
  ...
  /**
   * Method which listens for the information that the transfer for the given job is established. It
   * then verifies in which state is the job and based on that, handles the transfer information.
   */
  @Override
  public void action() {
