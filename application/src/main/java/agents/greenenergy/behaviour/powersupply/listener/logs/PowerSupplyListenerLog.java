package agents.greenenergy.behaviour.powersupply.listener.logs;
...
public class PowerSupplyListenerLog {
	...
	public static final String REQUEST_TO_MONITORING_AGENT_LOG = "[{}] Sending weather request to monitoring agent";

	// POWER SUPPLY STATUS LOG MESSAGES
	public static final String FINISH_POWER_SUPPLY_LOG = "[{}] Finish the execution of the job with id {}";
