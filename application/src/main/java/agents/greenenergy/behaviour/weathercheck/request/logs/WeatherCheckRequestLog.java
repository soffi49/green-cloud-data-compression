package agents.greenenergy.behaviour.weathercheck.request.logs;

/**
 * Class contains all constants dedicated to logging messages in weather checking request behaviours
 */
