package agents.greenenergy.behaviour.weathercheck.listener.logs;
...
public class WeatherCheckListenerLog {
	...
	public static final String POWER_DROP_LOG = "[{}] Received the weather data at {}. There was a power drop! Scheduling job transferring behaviour!";
	public static final String NO_POWER_DROP_LOG = "[{}] Received the weather data at {}. Power has not dropped. Continuing jobs execution";

	// NEW JOB WEATHER DATA LISTENER LOG MESSAGES
	public static final String INCORRECT_WEATHER_DATA_FORMAT_LOG = "[{}] I didn't understand the response with the weather data, sending refuse message to server";
	public static final String WEATHER_UNAVAILABLE_FOR_JOB_LOG = "[{}] Weather data not available, sending refuse message to server.";
	public static final String TOO_BAD_WEATHER_LOG = "[{}] Too bad weather conditions, sending refuse message to server for job with id {}.";
