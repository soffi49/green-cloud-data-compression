...
public class GreenEnergyManagementLog {
	...
	public static final String DUPLICATED_POWER_JOB_START_LOG = "[{}] Started job instance {}. Number of started job instances is {}";
	public static final String UNIQUE_POWER_JOB_FINISH_LOG = "[{}] Finished job {}. Number of unique finished jobs is {} out of {} started";
	public static final String DUPLICATED_POWER_JOB_FINISH_LOG = "[{}] Finished job instance {}. Number of finished job instances is {} out of {} started";
