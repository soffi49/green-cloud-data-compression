...
import static messages.domain.factory.PowerCheckMessageFactory.preparePowerCheckMessage;
...
public class CheckWeatherBeforeJobExecution extends WakerBehaviour {
	...
	private static void abortExecution(ServerAgent serverAgent, String jobId) {
		...
		logger.error(
				"[{}] Job with id {} must have been moved from the given server in the meantime, won't check weather.",
