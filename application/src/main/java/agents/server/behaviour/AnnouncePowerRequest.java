	...
	protected void handleAllResponses(Vector responses, Vector acceptances) {
		...
		if (responses.isEmpty()) {
			...
			if (!validProposals.isEmpty() && myServerAgent.getServerJobs()
				...
				logger.info("[{}] Chosen Green Source for the job with id {} : {}", myAgent.getName(), jobId,
				...
				myServerAgent.addBehaviour(
						new VolunteerForJob(myAgent, proposalMessage, chosenGreenSourceOffer.createReply()));
