...
public class PerformSourceJobTransfer extends WakerBehaviour {
	 ...
	 */
	private PerformSourceJobTransfer(Agent myAgent, Date transferTime, JobInstanceIdentifier jobInstanceId,
			AID newGreenSource) {
	 ...
	 */
	public static PerformSourceJobTransfer createFor(final ServerAgent serverAgent,
		...
		return new PerformSourceJobTransfer(serverAgent, Date.from(transferTime.toInstant()), jobInstanceId,
				newGreenSource);
	}
