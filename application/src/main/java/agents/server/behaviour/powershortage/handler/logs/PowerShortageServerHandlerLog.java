package agents.server.behaviour.powershortage.handler.logs;
...
public class PowerShortageServerHandlerLog {
	...
	public static final String POWER_SHORTAGE_HANDLE_JOB_ON_HOLD_TEMPORARY_LOG = "[{}] Job with id {} put temporarily on hold while looking for its transfer";
