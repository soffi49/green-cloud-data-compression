package agents.server.behaviour.jobexecution.initiator.logs;
...
public class JobHandlingInitiatorLog {
	...
	public static final String NEW_JOB_LOOK_FOR_GS_NO_SOURCES_AVAILABLE_LOG = "[{}] No Green Sources available - sending refuse message to Cloud Network Agent";
	public static final String NEW_JOB_LOOK_FOR_GS_NO_POWER_AVAILABLE_LOG = "[{}] No enough capacity - sending refuse message to Cloud Network Agent";
	public static final String NEW_JOB_LOOK_FOR_GS_SELECTED_GS_LOG = "[{}] Chosen Green Source for the job with id {} : {}. Sending job volunteering offer to Cloud Network Agent";
