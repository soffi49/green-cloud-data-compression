package agents.server.behaviour.jobexecution.listener.logs;
...
public class JobHandlingListenerLog {
	...
	public static final String SERVER_NEW_JOB_LACK_OF_POWER_LOG = "[{}] Not enough available power! Sending refuse message to Cloud Network Agent";
	...
	public static final String SUPPLY_CONFIRMATION_JOB_FINISHED_LOG = "[{}] Job {} must have been finished or transferred before its execution";
	public static final String SUPPLY_FINISHED_MANUALLY_LOG = "[{}] Information about finishing job with id {} does not reach the green source. Finished executing the job for {}";
