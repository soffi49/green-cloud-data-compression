...
public class ServerDFLog {
	...
	public static final String RECEIVE_GS_ANNOUNCEMENT_LOG =
			"Received message that {} new Green Source registered its service";
	public static final String RECEIVE_GS_DEREGISTRATION_LOG =
			"Received message that {} Green Source deregistered its service";
}
