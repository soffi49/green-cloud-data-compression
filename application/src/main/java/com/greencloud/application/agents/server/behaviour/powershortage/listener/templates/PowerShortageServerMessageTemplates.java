...
public class PowerShortageServerMessageTemplates {
	...
	public static final MessageTemplate SOURCE_JOB_TRANSFER_REQUEST_TEMPLATE = and(
			MatchPerformative(REQUEST), MatchProtocol(POWER_SHORTAGE_ALERT_PROTOCOL));
	...
	public static final MessageTemplate SOURCE_POWER_SHORTAGE_FINISH_TEMPLATE = and(
			MatchPerformative(INFORM), MatchProtocol(POWER_SHORTAGE_FINISH_ALERT_PROTOCOL));
}
