...
public class WeatherCheckRequestLog {
	...
	public static final String WEATHER_REQUEST_SENT_LOG = "[{}] Sending request for com.greencloud.application.weather to Monitoring Agent";

	// PERIODIC WEATHER CHECK LOG MESSAGES
	public static final String PERIODIC_CHECK_SENT_LOG = "[{}] Checking the current com.greencloud.application.weather";
}
