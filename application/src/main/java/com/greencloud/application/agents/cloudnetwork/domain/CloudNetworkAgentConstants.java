 ...
 * <p> MAX_POWER_DIFFERENCE 				 - value range describing the maximum difference in free power of the Server
 * 											   Agents that can be neglected in Server selection </p>
...
public class CloudNetworkAgentConstants {
	...
	public static final int MAX_NUMBER_OF_JOBS_IN_MESSAGE_BATCH = 50;
}
