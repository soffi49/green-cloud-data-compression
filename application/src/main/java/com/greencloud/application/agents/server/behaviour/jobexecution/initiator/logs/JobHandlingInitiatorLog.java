...
/**
 * Class contains all constants dedicated to logging information in Server initiator behaviours used during handling incoming jobs
 */
public class JobHandlingInitiatorLog {
	...
	public static final String SERVER_OFFER_ACCEPT_PROPOSAL_FAILURE_LOG =
			"Not enough power to execute the job {}. Sending failure information and rejecting green source proposal";
