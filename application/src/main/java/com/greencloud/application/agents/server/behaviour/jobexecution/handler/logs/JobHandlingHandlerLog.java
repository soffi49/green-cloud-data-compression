...
/**
 * Class contains all constants dedicated to logging information in Server handler behaviours used during handling executed jobs
 */
public class JobHandlingHandlerLog {

	// JOB START LOG MESSAGES
	public static final String JOB_START_NO_GREEN_SOURCE_LOG =
			"Job execution couldn't start: there is no green source for the job {}";
