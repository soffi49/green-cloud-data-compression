...
public class PowerShortageServerInitiatorLog {
	...
	public static final String SERVER_RE_SUPPLY_SUCCESSFUL_LOG =
			"Green source successfully supplied job {} again with green power. Changing job status in server";
	...
	public static final String CNA_JOB_TRANSFER_FAILURE_LOG =
