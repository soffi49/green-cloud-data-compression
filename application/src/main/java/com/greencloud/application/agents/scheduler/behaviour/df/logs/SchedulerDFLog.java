package com.greencloud.application.agents.scheduler.behaviour.df.logs;

/**
 * Class contains all constants used in logging information in scheduler DF behaviours
 */
public class SchedulerDFLog {
