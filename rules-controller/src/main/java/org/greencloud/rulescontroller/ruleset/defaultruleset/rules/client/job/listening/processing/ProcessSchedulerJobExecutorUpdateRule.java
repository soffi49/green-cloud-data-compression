...
import static org.greencloud.commons.enums.rules.RuleType.JOB_STATUS_RECEIVER_HANDLE_SCHEDULED_RULE;
...
public class ProcessSchedulerJobExecutorUpdateRule extends AgentBasicRule<ClientAgentProps, ClientNode> {

	private static final Logger logger = getLogger(ProcessSchedulerJobExecutorUpdateRule.class);

	private ACLMessage message;

	public ProcessSchedulerJobExecutorUpdateRule(
	...
	public boolean evaluateRule(final RuleSetFacts facts) {
		...
		return message.getConversationId().equals(UPDATE_JOB_EXECUTOR_ID);
	}
	...
	public void executeRule(final RuleSetFacts facts) {
		...
		logger.info("The server executing my job has changed to {}!", jobUpdate.getServerName());
