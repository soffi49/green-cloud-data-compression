...
import static org.greencloud.commons.enums.job.JobClientStatusEnum.DELAYED;
import static org.greencloud.commons.enums.rules.RuleType.JOB_STATUS_RECEIVER_HANDLER_RULE;
import static org.greencloud.commons.enums.rules.RuleType.JOB_STATUS_RECEIVER_HANDLE_DELAYED_RULE;
...
public class ProcessSchedulerDelayedJobUpdateRule extends AgentBasicRule<ClientAgentProps, ClientNode> {

	private static final Logger logger = getLogger(ProcessSchedulerDelayedJobUpdateRule.class);

	private ACLMessage message;

	public ProcessSchedulerDelayedJobUpdateRule(
	...
	public AgentRuleDescription initializeRuleDescription() {
		return new AgentRuleDescription(JOB_STATUS_RECEIVER_HANDLER_RULE, JOB_STATUS_RECEIVER_HANDLE_DELAYED_RULE,
	...
	public boolean evaluateRule(final RuleSetFacts facts) {
		...
		return message.getConversationId().equals(DELAYED_JOB_ID);
	}
	...
	public void executeRule(final RuleSetFacts facts) {
		...
		logger.info("The execution of my job has some delay! :(");

		agentNode.updateJobStatus(DELAYED);
		agentProps.updateJobStatusDuration(DELAYED, jobUpdate.getChangeTime());
