...
public class GraphUtils {
   ...
   */
  public static void addAgentEdgeToGraph(
      final Graph graph, final List<Edge> nodeEdges, final String agent1, final String agent2) {
   ...
   * @param agent2 name of the second agent
   */
  public static void addAgentBidirectionalEdgeToGraph(
      final Graph graph, final List<Edge> nodeEdges, final String agent1, final String agent2) {
   ...
   */
  public static void updateActiveEdgeStyle(
      final List<Edge> edges, final Graph graph, final boolean isActive, final String agent1, final String agent2) {
    synchronized (graph) {
      ...
      edges.stream()
          .filter(edge -> edge.getId().equals(edgeName))
          .forEach(edge -> edge.setAttribute("ui.class", dynamicEdgeStyle));
    }
  }
